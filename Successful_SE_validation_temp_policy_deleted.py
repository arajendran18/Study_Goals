...
def attach_policy_to_role(vault_url, vault_token, role_name, policy_name, iam_principal_arn):
    ...
    update_response = requests.post(f'{vault_url}/v1/auth/aws/role/{role_name}', headers=headers, json=role_data)
...
def lambda_handler(event, context):
    ...
    try:
        ...
        # Step 3: Attach the dynamic policy in addition to existing policies to the existing Vault role
        ...
        # Step 7: Delete the dynamic policy
